export default function IconFeatureCard(props) {
  ...
  return (
    <div
      className={`w-full tablet1:w-[290px] mt-[36px] tablet1:mt-0 desktop1:w-[250px] bg-white border rounded-md p-4 flex flex-col items-center desktop1:hover:scale-110 transition  ${className}`}
    >
      <div
